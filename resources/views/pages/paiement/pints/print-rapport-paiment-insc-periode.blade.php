...
<body>
    <div style="border: 1px solid black;padding: 6px">
        <div style="text-align: center;padding: 15px;font-size: 22px">
            <span>SITUATION DE PAIMENT DES INSCRIPTIONS PERIODIQUE</span>
        </div>
        <div>
            <span style="margin-top: 8px;margin-bottom: 8px "><span style="font-weight: bold">Période</span>: {{$label}}</span>
        </div>
        <div>
