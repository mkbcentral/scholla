            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    @if (Auth::user()->roles->pluck('name')->contains('root'))
                        ...
                        <x-nav-link class="nav-link" href="{{ route('paie.papport.inscription.mounth') }}"
                            :active="request()->routeIs('paie.papport.inscription.mounth')">
                            &#x1F4C3;
                    ...
                    @elseif (Auth::user()->roles->pluck('name')->contains('Finance'))
                        ...
                        <x-nav-link class="nav-link" href="{{ route('rapport.annuel') }}" :active="request()->routeIs('rapport.annuel')">
                            &#x1F5C3;
                            Rappport annuel
                        </x-nav-link>
