<div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mt-4">
                <div class="col-md-12">
                    <h2 class="text-bold text-primary">Total:CDF {{number_format($total,1,',',' ')}}</h2>
                    <h2 class="text-bold text-danger">Compte Etat:CDF {{number_format($total_etat,1,',',' ') }}</h2>
                    <h2 class="text-bold text-info">Reste pour école:CDF {{number_format($total-$total_etat,1,',',' ')}}</h2>
                </div>
            </div>
        </div>
    </div>
