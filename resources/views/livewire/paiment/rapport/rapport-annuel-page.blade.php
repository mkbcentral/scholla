                    ...
                    <div class="active tab-pane" id="inscription">
                       <div class="d-flex justify-content-between align-items-center">
                           <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="form-group mr-2">
                                ...
                                <x-select wire:model='option_id'>
                                    <option value="">Choisir...</option>
                                    @foreach ($optiosList as $option)
                                        <option value="{{$option->id}}">{{$option->name}}</option>
                                    @endforeach
                                </x-select>
                            </div>
                       ...
                       <div>
                        ...
                        <div class="d-flex justify-content-end ">
                            ...
                            <a target="_blank" href="{{ route('print.rapport.annuel', [$section_id,$type_id,$option_id]) }}" class="btn btn-info btn-sm">Imprimer</a>
                        </div>
