  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="addReqularisationPaieModal" tabindex="-1" role="dialog" aria-labelledby="addReqularisationPaieModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addReqularisationPaieModalLabel"> PASSER UNE REGULARISATION</h5>
