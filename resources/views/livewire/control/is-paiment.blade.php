                  ...
                  <div class="tab-content">
                    <div class="active tab-pane" id="inscription">
                       ...
                       <div>
                        ...
                        <div>
                            <div>
                                <h4 class="text-uppercase text-bold text-danger">
                                    Liste des élèves qui sont en ordre</h4></div>
                        </div>
                        <div class="d-flex justify-content-end ">
                            <span class="mr-4"><h3>Total: {{$inscriptions->count()}}</h3></span>
                            <a target="_blank" href="{{ route('is.paiment',[ $classe_id,$cost_id,$this->month,$this->defaultScolaryYer->id]) }}" class="btn btn-info btn-sm">Imprimer</a>
                        </div>
